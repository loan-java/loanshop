$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: 'UV阈值', name: 'maxuv', index: 'maxuv', width: 100}
        ],
        viewrecords: true,
        height: 385,
        rowNum: 10,
...
var vm = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function (event) {
            var url = vm.loan.id == null ? "sys/loan/save" : "sys/loan/update";
        ...
        getInfo: function (id) {
            $.get(baseURL + "sys/loan/info/" + id, function (r) {
                vm.loan = r.loan;
