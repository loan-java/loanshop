...
var vm = new Vue({
    ...
    methods: {
        download: function () {
            window.location.href = baseURL + "sys/logaso/export?state=" + vm.q.state + "&createDate=" + $('#qcreatedate').val();
        },
        query: function () {
            vm.reload();
        },
        ...
        saveOrUpdate: function (event) {
            var url = vm.logAso.id == null ? "sys/logaso/save" : "sys/logaso/update";
            $.ajax({
                type: "POST",
                url: baseURL + url,
        ...
        getInfo: function (id) {
            $.get(baseURL + "sys/logaso/info/" + id, function (r) {
                vm.logAso = r.logAso;
            });
        },
