...
$(function () {
    ...
    var colData = [
        ...
        {label: '渠道名', name: 'channelName', index: 'channel', width: 60},
        {
            label: '点击数：0',
            name: 'clicknum',
            index: 'clicknum',
        ...
        {label: 'UV注册率', name: 'uvzcl', index: 'uvzcl', width: 85},
        {label: '产品UV：0', name: 'loanUvNum', index: 'loanUvNum', width: 85},
        {label: '注册人均点击数', name: 'zcrjdjs', index: 'zcrjdjs', width: 85},
        {label: '今日产品UV：0', name: 'todayUvNum', index: 'todayUvNum', width: 85},
    ...
    $("#jqGrid").jqGrid({
        url: baseURL + 'sys/adminlogchannel/list',
        datatype: "json",
        colModel: colData,
        viewrecords: true,
        height: 385,
...
var vm = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function (event) {
            var url = vm.logChannel.id == null ? "sys/adminlogchannel/save" : "sys/adminlogchannel/update";
            $.ajax({
                type: "POST",
                url: baseURL + url,
        ...
        del: function (event) {
            ...
            confirm('确定要删除选中的记录？', function () {
                $.ajax({
                    type: "POST",
                    url: baseURL + "sys/adminlogchannel/delete",
                    contentType: "application/json",
        ...
        getInfo: function (id) {
            $.get(baseURL + "sys/adminlogchannel/info/" + id, function (r) {
